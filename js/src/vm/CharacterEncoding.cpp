...
template void InflateUTF8CharsToBufferAndTerminate(const UTF8Chars src, char16_t* dst,
                                       size_t dstLen,
                                       JS::SmallestEncoding encoding);
template void InflateUTF8CharsToBufferAndTerminate(const UTF8Chars src, JS::Latin1Char* dst,
                                       size_t dstLen,
                                       JS::SmallestEncoding encoding);
